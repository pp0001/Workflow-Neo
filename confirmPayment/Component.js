sap.ui
	.define(
		["sap/ui/core/UIComponent", "sap/ui/Device",
			"start/samples/confirmpayment/model/models"
		],
		function (UIComponent, Device, models) {
			...
			return UIComponent
				.extend(
					"start.samples.confirmpayment.Component", {
						...
						init: function () {
							...
							var oPositiveAction = {
								...
								onBtnPressed: function () {
									...
									// a JSON string
									var equip = JSON
										.stringify(processContext.Payment);
							...
							$
								.ajax({
									...
									success: function (
										...
										// and the equipment
										// list
										dataText = "{ \"status\":\"COMPLETED\",\"context\": {\"equipAssigned\": \"" + approvalStatus + "\" , \"Payment\" : " + equip +
											" }}";
