sap.ui.define(["sap/m/MessageToast",
	...
	return Controller.extend("start.samples.confirmpayment.controller.ConfirmEquipment", {
		
		paymentChange: function(oEvent) {
			this.getView().getModel().getData().Payment = oEvent.getSource().getValue();
		},

		onAddEquipment: function (oEvent) {
			if (!this.oDialog) {
				this.oDialog = sap.ui.xmlfragment("start.samples.confirmpayment.view.NewEquipment", this);
